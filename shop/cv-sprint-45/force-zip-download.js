(function (global) {
  var FILENAME = "CV_SPRINT_45_LAUNCH_EDITION.zip";
  ...
  function resolveFetchUrl(cfg) {
    ...
    return "https://workflow3terminal.github.io/downloads/cv-sprint-45/" + FILENAME;
  }
  ...
  async function forceZipDownload(fetchUrl, filename, statusEl, directUrl) {
    ...
    fetchUrl = fetchUrl || resolveFetchUrl(window.W3_PAYGATE && window.W3_PAYGATE.cv_sprint_45);
    directUrl = directUrl || resolveDirectUrl(window.W3_PAYGATE && window.W3_PAYGATE.cv_sprint_45);
